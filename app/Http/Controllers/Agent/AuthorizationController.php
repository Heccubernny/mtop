...
class AuthorizationController extends Controller
{
    ...
    public function showSMSFrom($token)
    {
        ...
        return view('agent.auth.authorize.verify-authorize-sms', compact('page_title', 'token'));
    }
    ...
    public function showSmsFormBeforRegister($token)
    {
        ...
        return view('agent.auth.authorize.verify-sms', compact('page_title', 'token', 'data'));
    }
    ...
    public function smsResendCode()
    {
        ...
        return redirect()->route('agent.authorize.sms', $data['token'])->with(['success' => [__('Verification code resend success')]]);
