...
class MoneyOutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.sections.money-out.index', compact('page_title', 'payment_gateways', 'transactions', 'wallet_currencies'));
    }
    ...
    public function paymentInsert(Request $request)
    {
        ...
        // daily and monthly
        try {
            (new TransactionLimit)->trxLimit('user_id', $userWallet->user->id, PaymentGatewayConst::TYPEMONEYOUT, $userWallet->currency, $validated['amount'], $gate, PaymentGatewayConst::SEND);
        } catch (Exception $e) {
