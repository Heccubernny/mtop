...
class AuthorizationController extends Controller
{
    ...
    public function showSMSFrom($token)
    {
        ...
        return view('user.auth.authorize.verify-authorize-sms', compact('page_title', 'token'));
    }
    ...
    public function showSmsFormBeforRegister($token)
    {
        ...
        return view('user.auth.authorize.verify-sms', compact('page_title', 'token', 'data'));
    }

    /**
     * Verify authorization code email.
     *
     * @return \Illuminate\Http\Response
     */
    ...
    public function smsResendCode()
    {
        ...
        return redirect()->route('user.authorize.sms', $data['token'])->with(['success' => [__('Verification code resend success')]]);
