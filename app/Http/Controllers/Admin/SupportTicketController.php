...
class SupportTicketController extends Controller
{
    ...
    public function messageReply(Request $request)
    {
        ...
        if (! $support_ticket) {
            return Response::error(['error' => [__('This support ticket is closed.')]]);
        }
    ...
    public function solve(Request $request)
    {
        ...
        if ($support_ticket->status == SupportTicketConst::SOLVED) {
            return back()->with(['warning' => [__('This ticket is already solved!')]]);
        }
