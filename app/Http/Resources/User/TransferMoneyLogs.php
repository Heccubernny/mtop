    ...
    public function toArray($request)
    {
        ...
        if ($this->attribute == payment_gateway_const()::SEND) {
            ...
            return [
                ...
                'exchange_rate' => get_amount(1, $this->details->charges->sender_currency ?? get_default_currency_code()).' = '.get_amount($this->details->charges->exchange_rate ?? get_default_currency_rate(), $this->details->charges->receiver_currency ?? get_default_currency_code(), get_wallet_precision($this->creator_wallet->currency)),
                ...
                'recipient_received' => get_amount($this->details->charges->receiver_amount ?? $this->details->recipient_amount, $this->details->charges->receiver_currency ?? get_default_currency_code(), get_wallet_precision($this->creator_wallet->currency)),
