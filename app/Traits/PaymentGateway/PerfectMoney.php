...
trait PerfectMoney
{
    ...
    {
        if (! $gateway) {
            throw new Exception('Oops! Payment Gateway Not Found!');
        }
    ...
    public function perfectMoneyRequestCredentials($gateway_credentials, $payment_gateway, $gateway_currency)
    {
        ...
        } elseif ($gateway_currency->currency_code == 'USD') {
            $request_credentials = [
    ...
    public function makingPerfectMoneyRedirectFormData($output, $payment_id)
    {
        ...
        return [
            ...
            [
                'name' => 'PAYMENT_AMOUNT',
                'value' => get_amount($output['amount']->total_amount ?? $output['charge_calculation']['requested_amount']),
            ],
            [
                'name' => 'PAYMENT_UNITS',
