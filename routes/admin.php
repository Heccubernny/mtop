...
use App\Http\Controllers\Admin\ExchangeMoneyLogController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(BillPayMethodController::class)->prefix('bill/pay/method')->name('bill.pay.method.')->group(function () {
        ...
        Route::prefix('automatic')->name('automatic.')->group(function () {
            ...
            Route::put('api/update', 'updateCredentials')->name('api.update');
            Route::put('ck-api/update', 'updateCKCredentials')->name('ck.api.update');
        });
    });
    ...
    // Exchange Money Logs
    Route::controller(ExchangeMoneyLogController::class)->prefix('exchange-money')->name('exchange.money.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('export-data', 'exportData')->name('export.data');
    });
    // GiftCard Logs
    ...
    // ReferralSettingController Settings
    Route::prefix('settings')->name('settings.')->group(function () {
        Route::controller(ReferralSettingController::class)->prefix('referral')->name('referral.')->group(function () {
            Route::get('index', 'index')->name('index');
            ...
            Route::prefix('package')->name('package.')->group(function () {
                ...
                Route::delete('delete', 'packageDelete')->name('delete');
                Route::put('status/update', 'packageStatusUpdate')->name('status.update');
            });
        });
    });
    // Setup KYC Section
