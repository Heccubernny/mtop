...
Route::controller(SiteController::class)->group(function () {
    ...
    Route::get('about', 'about')->name('about')->middleware(['page_setup:about']);
    Route::get('service', 'service')->name('service')->middleware(['page_setup:service']);
    Route::get('pricing', 'pricing')->name('pricing')->middleware(['page_setup:pricing']);
    Route::get('faq', 'faq')->name('faq');
    Route::get('web/journal', 'blog')->name('blog')->middleware(['page_setup:web-journal']);
    ...
    Route::get('agent-info', 'agentInfo')->name('agent')->middleware(['page_setup:agent']);
    Route::get('merchant-info', 'merchant')->name('merchant')->middleware(['page_setup:merchant']);
    Route::get('contact', 'contact')->name('contact')->middleware(['page_setup:contact']);
...
Route::controller(DeveloperController::class)->middleware(['page_setup:developer'])->prefix('developer')->name('developer.')->group(function () {
...
Route::controller(PaymentLinkController::class)->prefix('payment-link')->name('payment-link.')->group(function () {
    ...
    Route::prefix('gateway/payment')->name('gateway.payment.')->group(function () {
        ...
        // paystack
        Route::get('paystack/callback/response', 'paystackCallback')->name('callback.response');
    });
...
Route::get('user/cable/verify', [BillPayController::class, 'verify'])->name('verify');