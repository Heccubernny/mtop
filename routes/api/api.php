...
use App\Http\Controllers\Api\User\MoneyExchangeController;
...
use App\Http\Controllers\Api\User\ReferLevelController;
...
Route::prefix('user')->group(function () {
    ...
    // Airtime
    Route::get('/airtime/networks', 'airtimeNetworks');
    Route::post('/airtime/buy', 'buyAirtime');

    // Data
    Route::get('/data/networks', 'dataNetworks');
    Route::get('/data/plans/{networkId}', 'getPlans');
    Route::post('/data/buy', 'buyData');

    // Cable TV
    Route::get('/cable/providers', 'cableProviders');
    Route::get('/cable/packages/{providerId}', 'getPackages');
    Route::post('/cable/verify', 'verifySmartcard');
    Route::post('/cable/buy', 'buyCableTv');

    // Transactions
    Route::get('/transactions', 'transactions');
                Route::get('/services/data', 'dataServices');

                Route::get('/cable-tv/{service}/plans', 'cablePlans');
                Route::get('/data/{service}/plans', 'dataPlans');
                Route::post('/cable-tv/{service}/buy', 'buyCableTvs');
                Route::post('/data/{service}/buy', 'buyDatas');
