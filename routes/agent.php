...
use App\Http\Controllers\Agent\MoneyExchangeController;
...
Route::prefix('agent')->name('agent.')->group(function () {
    ...
    // Money Exchange
    Route::middleware('module:agent-money-exchange')->group(function () {
        // money exchange
    ...
    Route::middleware('module:agent-add-money')->group(function () {
        Route::controller(AddMoneyController::class)->prefix('add-money')->name('add.money.')->group(function () {
            ...
            // sslcommerz
            Route::post('sslcommerz/success', 'sllCommerzSuccess')->name('ssl.success')->withoutMiddleware(['auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
            Route::post('sslcommerz/fail', 'sllCommerzFails')->name('ssl.fail')->withoutMiddleware(['auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
            Route::post('sslcommerz/cancel', 'sllCommerzCancel')->name('ssl.cancel')->withoutMiddleware(['auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
            // Stripe
            ...
            Route::get('redirect/form/{gateway}', 'redirectUsingHTMLForm')->name('payment.redirect.form')->withoutMiddleware(['auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
            // redirect with Btn Pay
            Route::get('redirect/btn/checkout/{gateway}', 'redirectBtnPay')->name('payment.btn.pay')->withoutMiddleware(['auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
            Route::post('callback/response/{gateway}', 'callback')->name('payment.callback')->withoutMiddleware(['web', 'auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
            ...
            Route::post('success/response/{gateway}', 'postSuccess')->name('payment.global.success')->withoutMiddleware(['auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
            Route::post('cancel/response/{gateway}', 'postCancel')->name('payment.global.cancel')->withoutMiddleware(['auth:agent', 'verification.guard.agent', 'agent.google.two.factor', 'agent.sms.verification.guard']);
