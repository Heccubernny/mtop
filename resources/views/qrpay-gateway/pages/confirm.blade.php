                ...
                <div class="col-lg-6">
                    <div class="checkout-wrapper">
                        <div class="checkout-top-area">
                            ...
                            <span class="price-area">{{ get_amount($request_record->amount,$request_record->currency,4)  }}</span>
                        </div>
                        ...
                        <form class="checkout-form" method="POST" action="{{ $submit_form_url }}" id="payment-form">
                            ...
                            <div class="radio-wrapper">
                                ...
                                <div class="radio-item">
                                    ...
                                    @endphp
                                    <span class="amount-area">{{ get_amount($request_record->amount,$request_record->currency,4)  }}</span>
                                </div>
                                @endif
                                ...
                                <div class="radio-item">
                                    ...
                                    @if(isset($user->payment_type))
                                        ...
                                        @endphp
                                        <span class="amount-area">{{ get_amount($request_record->amount,$request_record->currency,3)  }}</span>
                                    @else
                                        ...
                                        @else
                                            <span class="amount-area">{{ get_amount($payable_card_balane,$card->currency,4)  }}</span>
                                        @endif
