                                ...
                                <div class="profile-thumb-content">
                                    ...
                                    <div class="profile-content">
                                        ...
                                        <ul class="user-info-list mt-md-2">
                                            <li><i class=" {{  $user->registered_by == global_const()::PHONE ? 'las la-phone' : 'las la-envelope' }}"></i>{{ __("Registered By") }} : {{ $user->registered_by ?? "" }}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        ...
                                        <select name="country" class="form--control select2-auto-tokenize country-select"
                                                ...
                                                {{ $user->registered_by == global_const()::PHONE ? 'disabled' : '' }}>
                                        </select>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form--control" placeholder="{{ __("enter Phone Number") }}" name="phone" value="{{ old('phone',auth()->user()->mobile) }}" {{ $user->registered_by == global_const()::PHONE ? 'readonly' : '' }}>
                                        </div>
                                    </div>

                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <label>{{__("Email")}}<span>*</span></label>
                                        <input type="email" name="email" class="form--control" placeholder="{{ __("Email") }}" value="{{ old('email',auth()->user()->email) }}" {{ $user->registered_by == global_const()::EMAIL ? 'readonly' : '' }} >
                                    </div>
