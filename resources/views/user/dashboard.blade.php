            ...
            <div class="dashboard-header-wrapper">
                ...
                <div class="dashboard-btn-wrapper">
                    <div class="dashboard-btn">
                        <a class="btn--base" href="{{ setRoute('user.wallets.index') }}">{{ __('View More') }}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-item-area">
                <div class="row mb-20-none">
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                ...
                                <h3 class="title">
                                    {{ get_amount($data['totalReceiveRemittance'], null, get_wallet_precision()) }} <span
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                ...
                                <h3 class="title">
                                    {{ get_amount($data['totalSendRemittance'], null, get_wallet_precision()) }} <span
                                        class="text--base">{{ @$baseCurrency->code }}</span></h3>
                            </div>
                            <div class="dashboard-icon">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                ...
                                <h3 class="title">{{ get_amount($data['cardAmount'], null, get_wallet_precision()) }}
                                    <span class="text--base">{{ @$baseCurrency->code }}</span>
                                </h3>
                            </div>
                            <div class="dashboard-icon">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                ...
                                <h3 class="title">{{ get_amount($data['billPay'], null, get_wallet_precision()) }} <span
                                        class="text--base">{{ @$baseCurrency->code }}</span></h3>
                            </div>
                            <div class="dashboard-icon">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                ...
                                <h3 class="title">{{ get_amount($data['topUps'], null, get_wallet_precision()) }} <span
                                        class="text--base">{{ @$baseCurrency->code }}</span></h3>
                            </div>
                            <div class="dashboard-icon">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                ...
                                <h3 class="title">{{ get_amount($data['withdraw'], null, get_wallet_precision()) }} <span
                                        class="text--base">{{ @$baseCurrency->code }}</span></h3>
                            </div>
                            <div class="dashboard-icon">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-20">
                        <div class="dashbord-item">
                            <div class="dashboard-content">
                                <span class="sub-title">{{ __('Total Cashback') }}</span>
                                <h3 class="title">{{ $data['total_cashback'] }} <span
                                        class="text--base">{{ @$baseCurrency->code }}</span></h3>
                                </h3>
                            </div>
                            <div class="dashboard-icon">
                    ...
                    <div class="chart-wrapper">
                        ...
                        <div class="chart-container">
                            <div class="chart" id="chart1"
                                data-chart_one_data="{{ json_encode($chartData['chart_one_data']) }}"
                                data-month_day="{{ json_encode($chartData['month_day']) }}"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chart-wrapper">
                        ...
                        <div class="chart-container">
                            <div class="chart" id="chart3"
                                data-chart_three_data="{{ json_encode($chartData['chart_two_data']) }}"
                                data-month_day="{{ json_encode($chartData['month_day']) }}"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="dashboard-header-wrapper">
                ...
                <div class="dashboard-btn-wrapper">
                    <div class="dashboard-btn mb-2">
                        <a class="btn--base" href="{{ setRoute('user.transactions.index') }}">{{ __('View More') }}</a>
                    </div>
                </div>
            </div>
