                ...
                <div class="row ml-b-20">
                    <div class="col-xl-4 col-lg-4 col-md-4 form-group">
                        @include('admin.components.form.input',[
                          ...
                          'placeholder'   => __("first Name"),
                            'value'         => old('firstname', isset($first_name) ? $first_name : ''),
                            'disabled'      => true,
                        ])
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 form-group">
                        @include('admin.components.form.input',[
                                    ...
                                    'value'         => old('lastname', isset($last_name) ? $last_name : ''),
                                    'disabled'      => true,
                        ])
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 form-group">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 form-group">
                        <div class="input-group">
                            ...
                            <input type="email" name="email" class="form--control" placeholder="{{ __("Email") }}" value="{{ old('email',$register_type == global_const()::EMAIL ? $credentials : '') }}" @if(@$register_type == global_const()::EMAIL) readonly @endif disabled>
                    ...
                    <div class="{{  isset($referral_info) &&  $referral_info->status == true ? "col-xl-6 col-lg-6" : "col-xl-12 col-lg-12" }} form-group">
                        <div class="input-group">
                            ...
                            <input type="number" class="form--control" placeholder="{{ __("enter Phone Number") }}" name="phone" 
                            value="{{ old('phone',isset($phone) ? $phone : '') }}"
                            {{-- value="{{ old('phone',$register_type == global_const()::PHONE ? $credentials : '') }}"  --}}
                            @if(@$register_type == global_const()::PHONE) readonly @endif disabled>
