...
@if ($basic_settings->push_notification_config != null && $basic_settings->push_notification_config->method == "pusher")
    ...
    <script>
        ...
        var generatePublisherId = "{{ make_user_id_for_pusher('user', auth()->user()->id) }}"; 
        ...
        beamsClient
            ...
            .then(() => beamsClient.setUserId(generatePublisherId, beamsTokenProvider))
            .catch((err) => {
                console.error("Pusher Beams registration failed:", err);
            });
        // }else{
        //     console.warn("Push notifications require HTTPS connection.");
        // }
