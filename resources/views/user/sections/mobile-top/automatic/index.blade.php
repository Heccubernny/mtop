                    ...
                    <div class="dash-payment-item active">
                        ...
                        <div class="dash-payment-body">
                            <form class="card-form" action="{{ setRoute('user.mobile.topup.automatic.pay') }}"
                                ...
                                <input name="phone_code" type="hidden">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 form-group">
                                        ...
                                        <div class="input-group mobile-code">
                                            ...
                                            <input class="form--control number-input" name="mobile_number" type="text"
                                    ...
                                    <div class="col-xl-12 col-lg-12">
                                        <button class="btn--base w-100 btn-loading mobileTopupBtn"
                                            type="submit">{{ __('Recharge Now') }} <i
    ...
    <script>
                ...
                if (response.status === true) {
                    ...
                    `);
                        ...
                        var multipliedAmounts = fixedAmounts.map(function(amount) {
                            return (amount * destination_exchange_rate).toFixed(acceptVar()
                                .sPrecison); // Set precision to two decimal places
                        });
                    ...
                    $('.fees-show, .add_item_fixed_wallet, .balance-show, .rate-show, .topup-type, .mobile-number, .request-amount, .conversion-amount, .fees, .payable-total')
                        .html('--');
                    $('.add_item_fixed_wallet').html('');
        ...
        function feesCalculation() {
            ...
            if ($.isNumeric(percent_charge) && $.isNumeric(fixed_charge) && $.isNumeric(sender_amount)) {
                // Process Calculation
                // console.log(currencyCode, defualCurrency);
                // currencyRate = if (currencyCode == defualCurrency) ? 1 : currencyRate;
                ...
                console.log({
                    fixed_charge_calc: fixed_charge_calc,
                    percent_charge_calc: percent_charge_calc,
        ...
        function getFee() {
            ...
            $(".fees-show").html("{{ __('TopUp Fee') }}: " + parseFloat(charges.fixed).toFixed(acceptVar().sPrecison) +
                " " + currencyCode + " + " + parseFloat(charges.percent).toFixed(acceptVar().sPrecison) + "%  ");
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.rate-show').html("1 " + walletCurrencyCode + " = " + parseFloat(exchangeRate).toFixed(
                        acceptVar().sPrecison) + " " + destination_currency_code);
                    getFee();
        ...
        function enterLimit() {
            ...
            if (supportsLocalAmounts == true && destination_currency_code == senderCurrencyCode && operator
                .localMinAmount == null && operator.localMaxAmount == null) {
        ...
        function senderBalance() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('.balance-show').text("Available Balance : " + parseFloat(response.data).toFixed(
                        acceptVar().sPrecison) + " " + senderCurrency);
                }
            });
        }
        ...
        function fixed_reload_amount_section() {
            ...
            // Multiply each value in fixedAmounts array by destination_exchange_rate
            var multipliedAmounts = fixedAmounts.map(function(amount) {
                return ((amount / exchangeRate) * destination_exchange_rate).toFixed(acceptVar()
                    .sPrecison); // Set precision to two decimal places
            });
            // Generate radio input fields for each multiplied amount
            var radioInputs = '';
