                ...
                <div class="header-menu-content">
                    <nav class="navbar navbar-expand-xl p-0">
                        <a class="site-logo site-title" href="{{ setRoute('index') }}">
                            <img data-white_img="{{ get_logo($basic_settings, 'white') }}"
                                data-dark_img="{{ get_logo($basic_settings, 'dark') }}"
                                src="{{ get_logo($basic_settings) }}" alt="site-logo">
                        </a>
                        ...
                        <div class="navbar-collapse collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav main-menu me-auto">
                                ...
                                @if (page_access('about'))
                                    <li class="nav-item">
                                        <a class="help-btn {{ menuActive('about') }}"
                                            href="{{ setRoute('about') }}">{{ __('About Us') }}</a>
                                    </li>
                                @endif
                                @if (page_access('service'))
                                    <li class="nav-item">
                                        <a class="help-btn {{ menuActive('service') }}"
                                            href="{{ setRoute('service') }}">{{ __('Our Service') }}</a>
                                    </li>
                                @endif
                                @if (page_access('pricing'))
                                    <li class="nav-item">
                                        <a class="help-btn {{ menuActive('pricing') }}"
                                            href="{{ setRoute('pricing') }}">{{ __('Pricing') }}</a>
                                    </li>
                                @endif
                            </ul>
                            <div class="navbar-right">
                                <ul>
                                    @if (page_access('contact'))
                                        <li class="nav-item">
                                            <a class="help-btn {{ menuActive('contact') }}"
                                                href="{{ setRoute('contact') }}">{{ __('Contact Us') }}</a>
                                        </li>
                                    @endif
                                </ul>
                                ...
                                <div class="header-action">
                                    @if (auth('web')->check())
                                        <a class="btn--base btn-auth"
                                            href="{{ setRoute('user.dashboard') }}">{{ __('Dashboard') }}</a>
                                    @elseif(auth('agent')->check())
                                        <a class="btn--base btn-auth"
                                            href="{{ setRoute('agent.dashboard') }}">{{ __('Dashboard') }}</a>
                                    @elseif(auth('merchant')->check())
                                        <a class="btn--base btn-auth"
                                            href="{{ setRoute('merchant.dashboard') }}">{{ __('Dashboard') }}</a>
                                    @else
                                        <a class="btn--base btn"
                                            href="{{ setRoute('user.login') }}">{{ __('Log In') }}</a>
                                        <a class="btn--base btn-auth"
                                            href="{{ setRoute('user.register') }}">{{ __('sign Up') }}</a>
                                    @endif
                                </div>
