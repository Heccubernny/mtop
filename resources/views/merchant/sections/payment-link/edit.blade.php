                                ...
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form--control number-input" placeholder="0.3" min="0.1" name="min_amount" value="{{ old('min_amount', $payment_link->min_amount ? get_amount($payment_link->min_amount,null,$payment_link->precision) : '') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-text prepend currency_link_symbol">£</div>
                                            <input type="text" class="form--control number-input" placeholder="10,000" min="0.2" name="max_amount" value="{{ old('max_amount', $payment_link->max_amount ? get_amount($payment_link->max_amount,null,$payment_link->precision) : '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form--control sub_price number-input" placeholder="0.00" name="price" value="{{ old('sub_price', get_amount(@$payment_link->price,null,$payment_link->precision)) }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 form-group">
                            ...
                            <div class="payment-preview-box-left">
                                <form class="payment-preview-box-left-form">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-text prepend currency_link_symbol">{{ $payment_link->currency_symbol }}</div>
                                            <input type="text" class="form--control paylink_amount" value="{{ get_amount($payment_link->price * $payment_link->qty,null,$payment_link->precision) }}" min="0.1" readonly>
                                        </div>
                                        <span class="limit-show">{{ get_amount($payment_link->min_amount,null,$payment_link->precision) }} {{ $payment_link->currency }} - {{ get_amount($payment_link->max_amount,null,$payment_link->precision) }} {{ $payment_link->currency }}</span>
                                    </div>
                                </form>
                        ...
                        <div class="payment-preview-box-left">
                            <form class="payment-preview-box-left-form">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-text prepend currency_link_symbol">{{ $payment_link->currency_symbol }}</div>
                                        <input type="text" class="form--control paylink_amount" placeholder="0.00" min="0.1" readonly value="{{ get_amount($payment_link->price * $payment_link->qty,null,$payment_link->precision) }}">
                                    </div>
                                    <span class="limit-show">{{ __("limit") }}: {{ get_amount($payment_link->min_amount,null,$payment_link->precision) }} {{ $payment_link->currency }} - {{ get_amount($payment_link->max_amount,null,$payment_link->precision) }} {{ $payment_link->currency }}</span>
                                </div>
                            </form>
                            <div class="payment-preview-thumb">
                                <img src="{{ get_fav($basic_settings) }}" alt="logo">
